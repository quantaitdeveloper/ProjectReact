  ...
  return (
    <div>
      <div className="container-fluid about">
        <div className="row">
          <div className="col-lg-1 col-md-2 col-xs-1 col-3 about-menu"></div>
          <div className="col-lg-11 col-md-10 col-9 about-content" id={1}>
            ...
            <div className="col-lg-12 section-content">
              <div className="row">
                ...
                <div className="col-lg-3">
                  ...
                  <p className="content-1">
                    I write about web design. It is a long established fact that
            ...
            <div className="row other-pages" id={404}>
              <div className="other-page-items">
                <button>404</button>
                <button>Blog</button>
